#!/bin/bash
# Build script for CLAD CLI executable
#
# Usage: ./scripts/build-clad.sh [output-path]
#
...
OUTPUT_PATH="${1:-$PROJECT_DIR/clad}"

echo "CLAD Build Script"
echo "=================="
